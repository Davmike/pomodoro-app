      ...
      <div className="w-[327px] h-[549px] bg-[white] rounded-[15px] absolute top-0 left-0">
            ...
            <div className="flex items-center justify-between w-[100%] px-[24px] mt-[18px]">
              ...
              <div className="flex items-center justify-between w-[140px] h-[40px] px-[16px] py-[12px] bg-[#EFF1FA] rounded-[10px]">
                <input
                  ...
                  onChange={(e) => context?.setPomodoro(Number(e.target.value))}
                />
                <div className="flex flex-col h-[20px] justify-between">
                  <img
                    src={arrowUp}
                    className="cursor-pointer"
                    onClick={() => context?.setPomodoro(context?.pomodoro + 1)}
                  />
                  <img
                    src={arrowDown}
                    className="cursor-pointer"
        ...
        <div className="flex flex-col items-center w-[100%] gap-[18px] md:flex-row md:justify-between md:mt-[24px] md:mb-[30px]">
          ...
          <div className="flex justify-between w-[152px] mb-[24px] md:m-0">
            ...
            >
              <img
                className={`${context?.color != 1 ? "hidden" : null} w-[20px]`}
                src={check}
              />
            </button>
            <button
            ...
            >
              <img
                className={`${context?.color != 2 ? "hidden" : null} w-[20px]`}
                src={check}
              />
            </button>
            <button
            ...
            >
              <img
                className={`${context?.color != 3 ? "hidden" : null} w-[20px]`}
                src={check}
              />
            </button>
          </div>
